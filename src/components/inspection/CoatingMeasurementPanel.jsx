      ...
      <div className="card-body">
        ...
        <div style={{
          ...
          <div>
            ...
            {/* Sample Progress mejorado - formato tabla */}
            <div className="mb-4">
              ...
              <div style={{
                ...
                {/* Header con números de muestra */}
                <div style={{
                  display: 'grid',
                  gridTemplateColumns: `repeat(${sampleCount}, 1fr)`,
                  ...
                  {Array.from({ length: sampleCount }).map((_, index) => (
                    <div key={index} style={{
                      ...
                      fontSize: '0.875rem',
                      color: '#374151',
                      borderRight: index < sampleCount - 1 ? '1px solid #e2e8f0' : 'none'
                    }}>
                      Sample {index + 1}
                    </div>
                  ))}
            ...
            {/* Gráficos y estadísticas (solo si hay datos) */}
