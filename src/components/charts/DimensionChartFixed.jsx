// src/components/charts/DimensionChartFixed.jsx
...
// Importar colores de dimensiones desde tus constantes o definirlos aquí
...
const DimensionChartFixed = () => {
  ...
  // Preparar datos para el gráfico usando tu función de utilidad
        ...
        <div className="h-64 bg-gray-50 border rounded">
          <ResponsiveContainer width="100%" height="100%">
            ...
            >
              ...
              {/* Líneas de referencia para valores nominales */}
              {chartViewMode === 'all' ? 
                dimensions.map(dim => (
                  <ReferenceLine
                    key={`ref-${dim.code}`}
              ...
              {/* Líneas de tolerancia en vista individual */}
              {chartViewMode === 'individual' && (
                <>
                  <ReferenceLine
                    y={dimensions.find(d => d.code === selectedDimForChart)?.nominal + 
...
export default DimensionChartFixed;